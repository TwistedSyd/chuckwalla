...
function Navigation({ onBackHome, currentPage, onNavigate }) {
  return (
    <div className="nav-icons">
      ...
      <div className={`nav-icon-button nav-circle ${currentPage === 'circle-of-fifths' ? 'active' : ''}`} title="Circle of Fifths" onClick={() => onNavigate('circle-of-fifths')} style={{ cursor: 'pointer' }}>
        <span className="spiral-emoji">🌀</span>
      </div>
    </div>
  );
}
